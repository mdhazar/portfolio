...
function Footer() {
  ...
  return (
    <footer className="bg-[#F9F9F9] dark:bg-black p-8 text-left mt-12  px-16 lg:px-16 xl:px 24 2xl:px-32">
      ...
      <a href={links.email} className="text-purple-400 underline flex items-center gap-2">
    ...
    <div className="flex gap-4">
      <p>Personal Blog</p>
      <a href={links.github} className="text-[#00AB6B]">Github</a>
      <a href={links.linkedin} className="text-[#0077B5]">Linkedin</a>
    </div>
</div>
